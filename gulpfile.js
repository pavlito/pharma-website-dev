...
gulp.task('watch:html', function() {
    gulp.watch('app/*.html').on('change', gulp.series(browserSync.reload))
});
...
gulp.task('default', gulp.series('clean-libs', gulp.parallel('fileinclude', 'copy', 'copy-bootstrap',  'watch', 'browser-sync')));
...
gulp.task("build", gulp.series(
    'clean',
    gulp.parallel('copy', 'img', 'sass-build', 'font', 'fileinclude'),
    'assets'
));